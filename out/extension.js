...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.ionic-preview-android', () => {
        lerConf();
        const panel = vscode.window.createWebviewPanel('ionicAndroid', 'Ionic Preview - Android', vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.ionic-preview-ios', () => {
        lerConf();
        const panel = vscode.window.createWebviewPanel('ionicIOS', 'Ionic Preview - iOS', vscode.ViewColumn.Two, {
            enableScripts: true,
            localResourceRoots: [vscode.Uri.file(path.join(context.extensionPath))]
        });
        const styleCssSrc = panel.webview.asWebviewUri(onDiskPath);
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.ionic-preview-windows', () => {
        lerConf();
        const panel = vscode.window.createWebviewPanel('ionicWindows', 'Ionic Preview - Windows', vscode.ViewColumn.Two, {
            enableScripts: true,
            localResourceRoots: [vscode.Uri.file(path.join(context.extensionPath))]
        });
        const styleCssSrc = panel.webview.asWebviewUri(onDiskPath);
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.ionic-preview-undefined', () => {
        lerConf();
        const panel = vscode.window.createWebviewPanel('ionicUndefined', 'Ionic Preview - Without Frame', vscode.ViewColumn.Two, {
            enableScripts: true,
            localResourceRoots: [vscode.Uri.file(path.join(context.extensionPath))]
        });
        const styleCssSrc = panel.webview.asWebviewUri(onDiskPath);
